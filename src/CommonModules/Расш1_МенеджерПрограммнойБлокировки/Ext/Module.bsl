...
Функция СнятьВсеБлокировки() Экспорт
	
	МассивФоновыхЗаданий = МассивФоновыхЗаданий(ИмяМетодаФоновогоЗадания(), СостояниеФоновогоЗадания.Активно);
...
КонецФункции //СнятьВсеБлокировки
...
Функция МассивФоновыхЗаданий(ИмяМетодаФоновогоЗадания, Состояние = Неопределено)
	
	Если Состояние = Неопределено Тогда
		Состояние = СостояниеФоновогоЗадания.Активно;		
	КонецЕсли; 
...
КонецФункции //МассивФоновыхЗаданий
